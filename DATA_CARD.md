...
| N-BaIoT | UCI Machine Learning Repository, dataset 442 (official archive) | N-BaIoT.zip, 9 device folders / 90 CSVs after extraction, DOI 10.24432/C5RC8J, as published 2018 | 2026-09-19 | CC BY 4.0 stated on the dataset page (verified) |
...
| deduplicated, capped at 200,000 per class | 413,209 | scale-sensitivity population (supplementary S27) |
| deduplicated, no cap | 2,429,503 | full corpus, train 1,700,652 / validation 364,425 / test 364,426 (supplementary S29) |
| N-BaIoT audit and benchmark | 180,000 | 60,000 rows per class (Benign, Gafgyt, Mirai); near-duplicates removed before splitting (supplementary S28) |

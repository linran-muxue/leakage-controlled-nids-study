...
source = source.replace('SOURCE = ROOT / "results_paper_materials_v3" / "full_paper_body_v5_unsw.md"', 'SOURCE = ROOT / "results_paper_materials_v3" / "full_paper_body_v7_final.md"')
source = source.replace('OUTPUT = ROOT / "论文完整正文_v5_UNSW类别分析稿.docx"', 'OUTPUT = ROOT / "results_paper_materials_v3" / "chinese_sci_manuscript_v1.docx"')

...
| Equal RF (chi-square) | 0.96304 | 0.96304 | **0.963215** | 0.13569 | 0.013453 | 0.026132 | 0.250 | 0.0284 |
| Equal RF (full features) | 0.96106 | 0.96106 | 0.960997 | **0.12237** | **0.012542** | 0.025232 | 0.235 | 0.0283 |
| ExtraTrees (chi-square) | 0.96106 | 0.96106 | 0.960947 | 0.15179 | 0.014300 | 0.036976 | 0.131 | 0.0296 |
...
| Best probability quality | Conditional weighting plus temperature scaling, reporting Log Loss and ECE together | Log Loss 0.0518 against 0.0522, but ECE is worse | About 5x inference cost; metrics disagree |
| Unknown-attack rejection | Equal-weight forest with an independent conformal threshold | AUROC 0.92-0.95 against 0.64-0.69 | Higher false-rejection rate on known classes; the operating point must be recalibrated |
